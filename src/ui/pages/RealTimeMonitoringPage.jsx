    ...
    <div className="real-time-monitoring-page page-transition">
      <div className="container">
        ...
        <div className="card" style={{ marginBottom: '20px' }}>
          <h1 style={{ textAlign: 'center', color: '#667eea', marginBottom: '32px', fontWeight: '700', fontFamily: '"PingFang SC", "Microsoft YaHei", Arial, sans-serif', WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale' }}>实时数据监测</h1>
        ...
        {/* 脑电波形显示 */}
        <div className="card" style={{ marginBottom: '20px' }}>
          <h3 style={{ marginBottom: '20px', fontWeight: '700', fontFamily: '"PingFang SC", "Microsoft YaHei", Arial, sans-serif', textShadow: '0 0 0 rgba(0, 0, 0, 0.2)', WebkitFontSmoothing: 'antialiased', MozOsxFontSmoothing: 'grayscale' }}>实时脑电波形</h3>
