      ...
      <div className="emotion-cloud-section">
        ...
        <div className="emotion-cloud">
          {emotionData.emotionDistribution.map((emotion, index) => {
            // 每种情绪只显示一次，通过字体大小体现频率
            // 基于频率调整字体大小，让高频情绪更明显
            const sizeMultiplier = 1 + (emotion.frequency - 1) * 0.2; // 频率每增加1，字体增大20%
            const finalSize = Math.min(emotion.adjustedSize * sizeMultiplier, 32); // 设置最大字体大小
            ...
            return (
              <div
                ...
                style={{
                  ...
                  left: `${randomX}%`,
                  top: `${randomY}%`,
                  opacity: 0.85 + (emotion.frequency * 0.02), // 高频词透明度更高
                  zIndex: emotion.frequency // 高频词显示在顶层
                }}
              >
                {emotion.name}
              </div>
