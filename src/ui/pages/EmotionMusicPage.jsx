    ...
    categories.forEach(category => {
      ...
      for (let i = 1; i <= count; i++) {
        musicData.push({
          ...
          coverUrl: `https://via.placeholder.com/300x300?text=${encodeURIComponent(category.name)}`,
          // 使用固定颜色主题
          coverBgColor: category.id === 'relax' ? '#a8dadc' : 
                       category.id === 'focus' ? '#f1faee' : 
                       category.id === 'happy' ? '#ffd166' : 
                       category.id === 'calm' ? '#06d6a0' : 
                       category.id === 'sleep' ? '#118ab2' : 
                       '#ef476f',
